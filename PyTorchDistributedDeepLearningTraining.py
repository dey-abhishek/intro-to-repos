...
# MAGIC %md
# MAGIC # Distributed deep learning training using PyTorch with HorovodRunner for MNIST
# MAGIC 
...
# MAGIC %md
# MAGIC ### Define a simple convolutional network
...
# MAGIC %md
# MAGIC ###Configure single-node training
...
# MAGIC %md
# MAGIC ### Create methods for saving and loading model checkpoints
...
# MAGIC %md
# MAGIC ### Run single-node training with PyTorch
